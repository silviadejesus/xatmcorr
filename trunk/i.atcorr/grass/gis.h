...
#define GIS_H_VERSION "$Revision: 50938 $"
#define GIS_H_DATE    "$Date: 2012-02-25 05:21:05 -0800 (Sat, 25 Feb 2012) $"
...
#define G_warning(x) cout<<x<<endl
#define G_fatal_error(x,y) cout<<x << y<<endl
#endif /* GRASS_GIS_H */
